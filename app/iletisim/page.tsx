...
export default function IletisimPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setError(err.message || "Mesaj gönderilemedi. Lütfen sonra tekrar deneyin.");
        } finally {
            setLoading(false);
        }
    };
                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <div className="bg-muted/50 border rounded-3xl p-6 space-y-3">
                        ...
                        <ul className="space-y-2 text-sm text-muted-foreground">
                            ...
                            <li><a href="/sss" className="hover:text-primary transition-colors">→ Verilerım güvende mi?</a></li>
